...
import type { InfoActionType } from 'types/dispatch/info'

export const defaultInfoState: InfoStateType = {
  hotkeys: false,
  ...
  resume_request_button: false,
  resume_response_button: false
}

export function info(state : InfoStateType = defaultInfoState, action: InfoActionType): InfoStateType {
  switch (action.type) {
